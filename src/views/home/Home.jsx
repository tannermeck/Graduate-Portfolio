    ...
    <article className={style.homeContainer}>
      ...
      <section className={style.aboutContainer}>
        <div className={style.profileImg}>
          ...
          <img
            className={style.aboutMeProfilePicture}
            src={profilePic}
            alt="profile picture"
            height="200"
          />
        ...
        <div className={style.profileContext}>
          <p>
            As a former Registered Nurse, being a life long learner is my most
            prestigious skillset. From being introduced to new diagnoses and
            procedures on a daily basis, to handling deadly viral precautions,
            learning became a fluid necessity. A few years later, I began my
            search into becoming a Software Engineer. What I found was
            exhilarating! It fed my passion for learning, building, assessing,
            and evaluating, all in a different and creative way. From always
            thinking on your toes to being comfortable with being uncomfortable,
            nursing has a direct correlation to my future as a Software
            Engineer.
          </p>
          <br />
          <p>
            My passion is fueled by my love of error resolution and innermost
            concern for writing clean-cut code. After graduating in January of
            2022, I hope to find work within the front-end of a motivated team
            of developers and continue to build my skills as a developer. When
            I'm not coding, I enjoy being a father to my wife and I's 10 month
            old son, playing with our two golden retrievers, and traveling to
            new destinations in our travel trailer.
          </p>
        </div>
